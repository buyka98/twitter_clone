...
class Utility {
  ...
  static bool validateCredentials(BuildContext context, String? email, String? password) {
    if (email == null || email.isEmpty) {
      ...
      customSnackBar(context, 'Password must me 6 character long');
      return false;
    }
  ...
  static createLinkAndShare(BuildContext context, String id, {required SocialMetaTagParameters socialMetaTagParameters}) async {
