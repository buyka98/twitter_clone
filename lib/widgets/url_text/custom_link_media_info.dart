...
import 'package:bwitter/model/link_media_info.dart';
import 'package:bwitter/ui/theme/theme.dart';
import 'package:bwitter/widgets/url_text/link_preview.dart';
...
class CustomLinkMediaInfo extends StatelessWidget {
  ...
  Future<Either<Exception, LinkMediaInfo>> fetchLinkMediaInfoFromApi(String url) async {
    try {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, AsyncSnapshot<Either<String, LinkMediaInfo>> snapshot) {
        if (snapshot.hasData) {
            ...
            (model) => Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: model.thumbnailUrl != null ? Colors.transparent : const Color(0xFFF0F1F2),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        color: model.thumbnailUrl != null ? Theme.of(context).colorScheme.onPrimary : const Color(0xFFF0F1F2),
                      ),
