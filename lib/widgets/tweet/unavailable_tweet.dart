...
class UnavailableTweet extends StatelessWidget {
  const UnavailableTweet({Key? key, required this.snapshot, required this.type}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      margin: EdgeInsets.only(right: 16, top: 5, left: type == TweetType.Tweet || type == TweetType.ParentTweet ? 70 : 16),
