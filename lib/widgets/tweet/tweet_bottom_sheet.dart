...
import 'package:bwitter/widgets/share_widget.dart';
      ...
      builder: (context) {
        return Container(
            ...
            height: MediaQuery.of(context).size.height *
                (type == TweetType.Tweet ? (isMyTweet ? .25 : .44) : (isMyTweet ? .38 : .52)),
    ...
    return Column(
      children: <Widget>[
        ...
        _widgetBottomSheetRow(
            ...
            isEnable: true, onPressed: () async {
          Navigator.pop(context);
          var uri = await Utility.createLinkToShare(
            context,
            "tweet/${model.key}",
            socialMetaTagParameters: SocialMetaTagParameters(
                description: model.description ?? "${model.user!.displayName} posted a tweet on Fwitter.",
